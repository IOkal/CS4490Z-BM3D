...

{
    ...
    for (i = 0, j = 0; i < imageHeight*imageWidth && j < imageHeight*imageWidth* 3; i++, j = j + 3)
    {
        ...
        cout << "TEAQSEAD" << endl;
    //Finding the count of each intensity value for R G B Channels
    for(k=0;k<=255;k++)
    {
    ...
    //Finding the CDF of R G B channels(values between 0 and 1) and mapping it back to values between 0 to 255
