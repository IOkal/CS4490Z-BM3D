...
mv ./ImNoisy.png outputs/baboon-iyad-sigma0/.
mv ./ImDiff.png outputs/baboon-iyad-sigma0/.
mv ./ImDenoised.png outputs/baboon-iyad-sigma0/.
mv ./ImBasic.png outputs/baboon-iyad-sigma0/.
mv ./measures.txt outputs/baboon-iyad-sigma0/.
